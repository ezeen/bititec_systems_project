...
urlpatterns = [
    ...
    path('lease-payments/', views.LeasePaymentViewSet.as_view({'get': 'list', 'post': 'create'})),
    path('lease-payments/<uuid:pk>/', views.LeasePaymentViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'})),
    path('leases/<uuid:pk>/add_payment/', views.LeaseContractViewSet.as_view({'post': 'add_payment'})),
    ...
    path('lease-part-inquiries/<uuid:pk>/payments/', views.LeasePartInquiryViewSet.as_view({'get': 'get_payments'})),
    path('lease-part-inquiries/<uuid:pk>/add_payment/', views.LeasePartInquiryViewSet.as_view({'post': 'add_payment'})),
    path('lease-part-inquiries/<uuid:pk>/delete_payment/<uuid:payment_id>/', views.LeasePartInquiryViewSet.as_view({'delete': 'delete_payment'})),
    ...
    path('lease-acc-inquiries/<uuid:pk>/payments/', views.LeaseAccInquiryViewSet.as_view({'get': 'get_payments'})),
    path('lease-acc-inquiries/<uuid:pk>/add_payment/', views.LeaseAccInquiryViewSet.as_view({'post': 'add_payment'})),
    path('lease-acc-inquiries/<uuid:pk>/delete_payment/<uuid:payment_id>/', views.LeaseAccInquiryViewSet.as_view({'delete': 'delete_payment'})),
    ...
    path('bills/summary/', views.BillsSummaryView.as_view(), name='bills-summary'),
    path('bills/unpaid/', views.UnpaidBillsView.as_view(), name='unpaid-bills'),
    path('payments/', views.PaymentAllocationView.as_view(), name='payment-allocation'),
]